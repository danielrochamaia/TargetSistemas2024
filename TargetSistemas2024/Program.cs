namespace MyApp
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("\n\nQuestão 4");
            var resposta = "Primeiramente podemos deixar um único interrupitor ligado e ir verificar nas salas qual luz está acesa." +
                "\nAgora, podemos ligar outro interrupitor e verificar novamente qual sala corresponde a ele." +
                "\nPor fim, como só restou uma sala, podemos afirmar que o interrupitor final é dela sem precisar verificar pessoalmente.";
